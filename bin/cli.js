...
function printHelp() {
    ...
    console.log('                           Available: default, review, llm-explain, pair-program,');
    console.log('                           security-audit, documentation, minimal, full');
    console.log('  --list-presets           List all available presets with descriptions');
    console.log('  --preset-info NAME       Show detailed information about a preset');
    console.log();
    console.log('Token Budget Optimization (v3.1.0):');
    console.log('  --target-tokens N        Fit output within token budget');
    console.log('                           Formats: 100000, 100k, 1.5M');
    console.log('  --fit-strategy TYPE      Fitting strategy (default: auto)');
    console.log('                           auto        - Automatically select best strategy');
    console.log('                           shrink-docs - Remove documentation files first');
    console.log('                           balanced    - Optimize token/file efficiency');
    console.log('                           methods-only- Extract only methods (60-80% reduction)');
    console.log('                           top-n       - Select most important files');
    console.log();
    console.log('Rule Debugging (v3.1.0):');
    console.log('  --trace-rules            Enable detailed rule tracing');
    console.log('                           Shows why files/methods are included or excluded');
    console.log('                           Displays pattern analysis and unused patterns');
    console.log();
    ...
    console.log('    context-manager --list-presets                 # List all available presets');
    console.log('    context-manager --preset-info review           # Show preset details');
    ...
    console.log('    context-manager --target-tokens 100k           # Fit within 100k tokens');
    console.log('    context-manager --target-tokens 50k --fit-strategy balanced');
    console.log('    context-manager --target-tokens 30k --fit-strategy methods-only');
    console.log('    context-manager --preset review --target-tokens 80k  # Preset + budget');
    console.log();
    console.log('  Rule Tracing:');
    console.log('    context-manager --trace-rules                  # Debug filter decisions');
    console.log('    context-manager --preset review --trace-rules  # Trace with preset');
    console.log('    context-manager --target-tokens 100k --trace-rules  # Trace with budget');
    console.log();
    console.log('  Combined Workflows:');
    console.log('    context-manager --preset review --target-tokens 80k --trace-rules');
    console.log('    context-manager --preset llm-explain --target-tokens 30k --fit-strategy methods-only');
    console.log('    context-manager --preset security-audit --save-report --trace-rules');
    console.log();
    ...
    console.log();
    console.log('Common Flag Combinations:');
    console.log('  --preset + --target-tokens       Preset with custom token budget');
    console.log('  --preset + --trace-rules         Debug preset filter decisions');
    console.log('  --target-tokens + --fit-strategy Explicit budget and strategy');
    console.log('  --target-tokens + --trace-rules  See why files were excluded');
    console.log('  --preset + --save-report         Preset with detailed reporting');
    console.log('  --cli + any analysis flag        Force CLI mode (skip wizard)');
    console.log();
